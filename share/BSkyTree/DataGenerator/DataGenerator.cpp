...
vector<double*> GenerateIndependent(int nNumObj, int nNumAtt, bool bDistinct)
{
...
vector<double*> GenerateCorrelated(int nNumObj, int nNumAtt, bool bDistinct)
{
	vector<double*> TotalData;
...
vector<double*> GenerateAntiCorrelated(int nNumObj, int nNumAtt, bool bDistinct)
{
	vector<double*> TotalData;
